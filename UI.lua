...
if not game:GetService("CoreGui"):FindFirstChild(game.PlaceVersion * 99999) then
	local ui = Instance.new("ScreenGui")
	ui.Name = game.PlaceVersion * 99999
	ui.Parent = game.CoreGui
	ui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
else
	game:GetService("CoreGui"):FindFirstChild(game.PlaceVersion * 99999):Destroy()
	local ui = Instance.new("ScreenGui")
	ui.Name = game.PlaceVersion * 99999
	ui.Parent = game.CoreGui
	ui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
